 ...
 */
const isImage = (file) =>
  ["png", "jpg", "jpeg", "gif", "bmp", "svg"].includes(file.ext);
...
const fetchFiles = async (
  ...
  try {
    console.log("fetching files from ", currentBucket + "/" + path);
    ...
    const newPath = currentBucket + "/" + path;
    const fileRequest = { data: { path: newPath } };
